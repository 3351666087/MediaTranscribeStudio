...
export const modelStrategies: ModelStrategy[] = [
  {
    ...
    semanticModel: "qwen3.5:9b",
    semanticModelStatus: "suggestion_only",
    semanticModelEvaluation: "Production evaluation: qwen3.5:9b is required for fail-closed semantic arbitration; it remains suggestion-only and cannot auto-edit transcript text or speakers.",
    estimatedVramGb: 7.2,
    semanticGuardrail: "The model may only choose an acoustically backed candidate or abstain; it cannot create speakers, move boundaries, or overwrite raw text.",
    recommended: true,
  },
  {
    id: "quality",
