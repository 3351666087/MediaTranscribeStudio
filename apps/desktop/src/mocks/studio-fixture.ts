...
export const modelStrategies: ModelStrategy[] = [
  {
    ...
    semanticModel: "qwen3.5:27b-q4_K_M",
    semanticModelStatus: "suggestion_only",
    semanticModelEvaluation: "Production evaluation: qwen3.5:27b-q4_K_M won the current multilingual semantic challenge; every decision remains evidence-bound and fail-closed.",
    estimatedVramGb: 7.2,
