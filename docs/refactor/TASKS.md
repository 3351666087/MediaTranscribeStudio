...
- [ ] 在已完成 `N=2/3/5/8` 真实回归与派生 `N=13` 压力回归后，继续重跑真实 `N=1`、更多真实 `N>=8` 和冻结的新 held-out；对有完整逐字真值的多人样本同时报告人数后验校准、DER/JER、overlap、cpWER/tcpWER/SA-WER、边界、冷/热 RTF 和复核量。该项未完成前不得宣称任意人数或整体质量通过。
