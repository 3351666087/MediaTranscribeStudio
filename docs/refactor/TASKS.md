...
- [ ] 用 pipeline `2.10.0` 分别重跑真实 Liva N=3/N=5，验证 `ALL_SINGLETON_PARTITION_DEGENERACY`、候选区间、Pyannote 冲突和 worker 生命周期，再独立评分人数、DER/JER、confusion、overlap、边界、语言集合、复核量与 RTF；不得用缓存静态转移或人数改善代替真实质量结论。
